...
from config import COLOR_RED, COLOR_YELLOW, ZOOM_DISTANCE, HIGHLIGHT_RADIUS, CROSSHAIR_LENGTH, BLINK_DURATION, HIGHLIGHT_DURATION
...
class CadConnector:
    ...
    def zoom_to_point(self, x, y):
        ...
        try:
            ...
            line1_start = VARIANT(pythoncom.VT_ARRAY | pythoncom.VT_R8, [x - CROSSHAIR_LENGTH, y, 0])
            line1_end = VARIANT(pythoncom.VT_ARRAY | pythoncom.VT_R8, [x + CROSSHAIR_LENGTH, y, 0])
            temp_line1 = mspace.AddLine(line1_start, line1_end)
            temp_line1.Color = COLOR_RED
            
            line2_start = VARIANT(pythoncom.VT_ARRAY | pythoncom.VT_R8, [x, y - CROSSHAIR_LENGTH, 0])
            line2_end = VARIANT(pythoncom.VT_ARRAY | pythoncom.VT_R8, [x, y + CROSSHAIR_LENGTH, 0])
